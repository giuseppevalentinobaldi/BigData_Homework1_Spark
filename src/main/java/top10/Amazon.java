...
public class Amazon implements Serializable {
	...
	public Amazon(int id, String productId, String userId, String profileName, int helpfulnessNumerator,
			int helpfulnessDenominator, int score, long timestamp, String summary, String text) {
		this.setId(id);
